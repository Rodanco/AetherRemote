...
public class MainWindowExperiment : Window
{
    ...
    public MainWindowExperiment(NetworkProvider networkProvider, FriendListProvider friendListProvider, IPluginLog logger, Configuration configuration, SecretProvider secretProvider) : base("Aether Remote - Version 1.0.0.0", MainWindowFlags)
    {
        ...
        [
            ...
            new SessionsTabExperimental(friendListProvider, logger),
